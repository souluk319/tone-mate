...
4. [ChainShield #1470 E2E 명세](docs/specs/chainshield-1470-e2e-spec-v1.md) — Conan·Swift·CocoaPods·Pub 실사용 검증
...
제품은 실제 사용자 가치를 위해 개발한다. ChainShield #1470은 고정된 제품 commit의 실제 패키지 게시·소비·빌드 과정을 검증하는 병행 QA이며 제품 구조를 지배하지 않는다.
